...
const WidgetJabatanChoice = ({ callback }) => {
  ...
  return (
    <Card>
      ...
      <Card.Footer>
        <Pagination>
          <Pagination.First disabled={!daftarJabatanPagination.previous}
          ...
          <Pagination.Last disabled={!daftarJabatanPagination.next}
                           onClick={() => onJabatanPagination(daftarJabatanPagination.totalPage)} />
        </Pagination>
      </Card.Footer>
    </Card>
  )
