        ...
        <Modal.Body>
          ...
          <Row className="mb-3">
            ...
            <Col md={6}>
              ...
              <Card>
                <Card.Body value={jabatan}>
                  Nama Jabatan : {jabatan.nama}
                </Card.Body>
                <Card.Body value={jabatan}>
                  Gaji Pokok: {jabatan.gajiPokok}
                </Card.Body>
                <Card.Body value={jabatan}>
          ...
          {/* <Row>
                ...
                <Form.Group className={"mb-3"}>
                    ...
                    <Form.Control name={"jabatan"} value={jabatan.nama} onChange={handleJabatanChange} readOnly />
                </Form.Group>
                </Col>
                <Col md={6}>
                <Form.Group className={"mb-3"}>
                    <Form.Label>Gaji Pokok</Form.Label>
                    <Form.Control name={"gajiPokok"} value={jabatan.gajiPokok} onChange={onCallbackJabatanChoice}
                        readOnly />
                </Form.Group>
                </Col>
            </Row> */}
              ...
              <Table striped={true} bordered={true} responsive={true}>
                ...
                <tbody>
                  {/* <tr>
                            <th>Berat</th>
                            <td>
                                <Form.Control placeholder={"dalam Kg"} value={terima.berat} type={"number"}
                                    name={"berat"} onChange={(e)=> changeListener.onChangeNumber(e, terima, setTerima)}
                                    />
                            </td>
                        </tr> */}
                </tbody>
