      ...
      <Container className={"mt-4"}>
        <Row className={"mb-4"}>
          ...
          <Col className={"d-flex justify-content-end"}>
            <Button onClick={() => navigate("departemen")}>Tambah Departemen</Button>
          </Col>
        </Row>
        <Row className={"mb-4"}>
          <Col md={12}>
            <Card>
              <Card.Body>
                <Row>
                  <Col>
                    <Form.Group>
                      <Form.Control ref={departemenSearch}
              ...
              <Card.Footer>
                <Pagination>
                  <Pagination.First disabled={!daftarDepartemenPagination.previous}
                  ...
                  <Pagination.Last disabled={!daftarDepartemenPagination.next}
                                   onClick={() => onDepartemenPagination(daftarDepartemenPagination.totalPage)} />
                </Pagination>
              </Card.Footer>
            </Card>
          </Col>
