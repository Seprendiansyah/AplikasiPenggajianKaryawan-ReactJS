      ...
      <Container className={"mt-4 mb-4"} fluid={true}>
                ...
                <tr>
                  ...
                  <td>
                    {jumlahPotonganAbsensi(
                      data.absensi.nominalAlpa,
                      data.absensi.nominalTerlambat
                    )}
                  </td>
                </tr>
              </tbody>
        ...
        <Row>
          <Col className={"d-flex justify-content-center gap-3"}>
            <Button className={"d-print-none"} onClick={() => navigate("/")}>
              Back
            </Button>
...
export default PageKaryawanPrint;
